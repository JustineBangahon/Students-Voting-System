...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 01, 2023 at 08:16 PM
...
CREATE TABLE `tblstudent` (
  ...
  `vote_status` char(15) NOT NULL COMMENT '0 - voted\r\n1 - not voted'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Triggers `tbl_year_level`
--
DELIMITER $$
CREATE TRIGGER `insert_studentdesc` BEFORE INSERT ON `tbl_year_level` FOR EACH ROW BEGIN 
INSERT INTO tbl_student_description VALUES (NEW.year_level_id);
END
$$
DELIMITER ;
...
ALTER TABLE `tblcandidate`
  ...
  ADD KEY `candidateposition_id` (`candidate_position_id`),
...
--
ALTER TABLE `tbl_candidate_position`
  MODIFY `candidate_position_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `tbl_election_date`
--
ALTER TABLE `tbl_election_date`
  MODIFY `election_date_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `tbl_year_level`
  MODIFY `year_level_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `tblcandidate`
  ADD CONSTRAINT `tblcandidate_ibfk_1` FOREIGN KEY (`candidate_position_id`) REFERENCES `tbl_candidate_position` (`candidate_position_id`),
