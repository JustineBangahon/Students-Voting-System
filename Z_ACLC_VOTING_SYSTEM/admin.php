    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                // Fetch admin data from tbladmin
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<td>';
                        echo '<a href="update_admin.php?updateid=' . $row['admin_id'] . '" class="btn btn-sm btn-primary mr-2">Update</a>';
                        echo '<a href="delete_admin.php?deleteid=' . $row['admin_id'] . '" class="btn btn-sm btn-danger">Delete</a>';
                        echo '</td>';
                        echo '</tr>';
                    }
                } else {
